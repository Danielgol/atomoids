...
describe("Ship Test", function(){
    ...
    it("Test applyForces", function(){
        ...
        expect(51).toBe(ship.x);
        expect(49).toBe(ship.y);
    ...
    it("test ship forces when in 269 degrees", function(){
        ...
        expect(-0.00010471443862370099).toBe(ship.forceY);
        expect(-0.0059990861709383475).toBe(ship.forceX);
    ...
    it("test ship forces when in 271 degrees", function(){
        ...
        expect(0.00010471443862369878).toBe(ship.forceY);
        expect(-0.0059990861709383475).toBe(ship.forceX);
    ...
    it("test ship forces when in 179 degrees", function(){
        ...
        expect(-0.0059990861709383475).toBe(ship.forceY);
        expect(0.00010471443862370063).toBe(ship.forceX);
    ...
    it("test ship forces when in 181 degrees", function(){
        ...
        expect(-0.0059990861709383475).toBe(ship.forceY);
        expect(-0.00010471443862369916).toBe(ship.forceX);
    ...
    it("test ship forces when in 359 degrees", function(){
        ...
        expect(0.0059990861709383475).toBe(ship.forceY);
        expect(-0.00010471443862370669).toBe(ship.forceX);
    ...
    it("test ship forces when in 1 degrees", function(){
        ...
        expect(0.0059990861709383475).toBe(ship.forceY);
        expect(0.00010471443862370107).toBe(ship.forceX);
