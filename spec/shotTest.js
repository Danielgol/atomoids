...
describe("Shot Test", function() {
    ...
    beforeEach(function(){
     ...
     it("test shot position in 89 degrees", function(){ 
    
        shot = new Shot(circle, 89);
     ...
     it("test shot position in 91 degrees", function(){ 
    
        shot = new Shot(circle, 91);

        shot.move(1);

        expect(1.9998476951563913).toBe(shot.circle['pos'].x);
        expect(1.0174524064372834).toBe(shot.circle['pos'].y);

     });

     it("test shot position in 269 degrees", function(){ 
    
        shot = new Shot(circle, 269);
     ...
     it("test shot position in 270 degrees", function(){ 
    
        shot = new Shot(circle, 270);
     ...
     it("test shot position in 179 degrees", function(){ 
    
        shot = new Shot(circle, 179);

        shot.move(1);

        expect(1.0174524064372834).toBe(shot.circle['pos'].x);
        expect(1.9998476951563913).toBe(shot.circle['pos'].y);

     });

     it("test shot position in 180 degrees", function(){ 
    
        shot = new Shot(circle, 180);

        shot.move(1);

        expect(1).toBe(shot.circle['pos'].x);
        expect(2).toBe(shot.circle['pos'].y);

     });

     it("test shot position in 181 degrees", function(){ 
    
        shot = new Shot(circle, 181);

        shot.move(1);

        expect(0.9825475935627168).toBe(shot.circle['pos'].x);
        expect(1.9998476951563913).toBe(shot.circle['pos'].y);

     });

     it("test shot position in 359 degrees", function(){ 
    
        shot = new Shot(circle, 359);

        shot.move(1);

        expect(0.9825475935627156).toBe(shot.circle['pos'].x);
        expect(0.00015230484360873042).toBe(shot.circle['pos'].y);

     });

     it("test shot position in 360 degrees", function(){ 
    
        shot = new Shot(circle, 360);
     ...
     it("test shot position in 1 degree", function(){ 
    ...
    it("test shot position when X is smaller than canvas width ", function(){
        ...
        expect(999).toBe(shot.circle['pos'].x);

    });

    it("test shot position when X is bigger than 0 ", function(){
    ...
    it("test shot position when X is smaller than 0 ", function(){
    ...
    it("test shot position when Y is equal to canvas height ", function(){
        ...
        expect(height).toBe(shot.circle['pos'].y);

    });

    it("test shot position when Y is smaller than canvas height ", function(){
        ...
        expect(599).toBe(shot.circle['pos'].y);

    });

    it("test shot position when Y is bigger than 0 ", function(){
    ...
    it("test shot position when Y is equal to 0 ", function(){
    ...
    it("test shot position when Y is smaller than 0 ", function(){
