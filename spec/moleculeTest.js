...
describe("moleculeTest", function() {
  ...
  it("test divide function", function() {
    ...
    for(i=0; i<numberOfAtoms; i++){
      atoms.push(new Atom(new SAT.Circle(new SAT.Vector(50, 50), 25) , 5, "red"));
    }

		var molecule = new Molecule(atoms, 5);
    var aloneAtoms = [];

    expect(0).toBe(aloneAtoms.length);

    aloneAtoms = molecule.divide(aloneAtoms);

    expect(numberOfAtoms).toBe(aloneAtoms.length);
